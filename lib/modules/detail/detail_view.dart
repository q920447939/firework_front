                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            children: product.specs.map((spec) {
                              final isSelected =
                                  controller.selectedSpec.value == spec;
                              return ChoiceChip(
                                label: Text(spec),
                                selected: isSelected,
        ...
        child: SafeArea(
          child: Row(
            children: [
              ...
              ), // Corrected: context.push requires go_router import, but here we can just use Get or Navigator if context available. Wait, we use go_router.
